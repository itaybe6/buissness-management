-- ============================================================================
-- 050: תעודת זהות לעובדים (מודול מסמכים)
...
drop trigger if exists trg_employee_id_cards_updated on public.employee_id_cards;
...
drop policy if exists "employee_id_cards_select" on public.employee_id_cards;
...
drop policy if exists "employee_id_cards_insert" on public.employee_id_cards;
...
drop policy if exists "employee_id_cards_update" on public.employee_id_cards;
...
drop policy if exists "employee_id_cards_delete" on public.employee_id_cards;
