-- ============================================================================
-- 046: ספקים קבועים + supplier_id בהזמנות מלאי ובמסמכים פיננסיים
-- ============================================================================
...
create index if not exists idx_office_receipts_supplier on public.office_receipts(business_id, supplier_id);
