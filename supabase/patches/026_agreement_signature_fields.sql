...
drop policy if exists "agr_signatures_select" on public.agreement_signatures;
drop policy if exists "agr_signatures_insert" on public.agreement_signatures;
drop policy if exists "agr_signatures_update" on public.agreement_signatures;
