...
create table if not exists public.payroll_month_adjustments (
...
create index if not exists idx_payroll_month_adj_business on public.payroll_month_adjustments(business_id);
create index if not exists idx_payroll_month_adj_period on public.payroll_month_adjustments(business_id, period_month);

alter table public.payroll_month_adjustments enable row level security;

drop policy if exists "payroll_month_adj_tenant" on public.payroll_month_adjustments;
